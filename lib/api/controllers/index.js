...
var debug = require('debug')('shop:controller');
...
exports.getProducts = function (req, res, next) {
    ...
    var getProductsPromise = mongodb.Product
        .find()
    ...
    var getTotalCountPromise = mongodb.Product.find().count().exec().then(function (count) {
...
exports.getProductsByCategoryId = function (req, res, next) {
    ...
    var getProductsPromise = mongodb.Category
    ...
    var getTotalCountPromise = mongodb.Category
        .findById(category_id)
        .populate({
            path: 'products'
        }).exec().then(function (category) {
