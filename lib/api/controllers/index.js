...
exports.createProductWithCommit2Phases = function createProductWithCommit2Phases(req, res, next) {

    var singleResource = req.body;

    jsonApiUtils.createDocumentForResourceWith2PhaseCommit(singleResource).then(function (resp) {
